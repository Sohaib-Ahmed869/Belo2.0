...
const EmailTemplate = ({ show, setShow }) => {
  return (
    <Modal
      show={show}
              ...
              <div className="flex space-x-4">
                <div className="w-full">
                  ...
                  <textarea
                    ...
                    className="mt-1 block w-full h-48 border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
              </div>
            </div>

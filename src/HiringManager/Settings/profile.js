            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border border-gray-300 rounded"
                />
                <p  className="text-blue-500 text-sm mt-2 block" onClick={() => setShowEmailModal(true)}>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border border-gray-300 rounded"
                />
                <p  className="text-blue-500 text-sm mt-2 block" onClick={() => setShowPhoneModal(true)}>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border border-gray-300 rounded"
                />
                <p className="text-blue-500 text-sm mt-2 block" onClick={() => setShowPasswordModal(true)}>
